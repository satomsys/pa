...
<div class="section section-nav">
  <div class="wrap">
    <nav class="careerSelectNav">
      <ul>
        <li class="careerSelectNav_vision<?php if( isset( $visionIsActive ) ) echo' active'; ?>" data-genre="vision"><a <?php if( ! isset($visionIsActive) ) echo 'href="index.html"'; ?>>VISION</a></li>
