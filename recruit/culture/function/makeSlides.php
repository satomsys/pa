	...
	*/
	public function mainslide(){
		...
		$text = array(
			...
			ためになるのか<br>
			徹底的に、本質を掴む',
			'上司と部下、<br>立場に関係なく<br>楽しむひとときがある。',
			'どんなプランが最適か、<br>
			お互いの意見を汲み取り<br>
			お客様の事を<br>
			お客様以上に考え抜く',
			'仲間と一致団結して、<br>仕事を動かしていく。<br>社員同士の強い絆がある。',
			'お互いに切磋琢磨する<br>同期ミーティングで、<br>さらなる成長をめざす。',
			'部署の垣根を超えて、<br>ダイナミックに<br>プロジェクトは進む。',
			'先輩も後輩も、<br>同じ人間同士。<br>尊敬し合って働く。',
			'男女関係なく、<br>気軽に相談できる。<br>心地よい人間関係がある。'
			);
