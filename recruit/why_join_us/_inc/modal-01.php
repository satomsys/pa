<div class="wjuQ_modal wjuQ_modal-1 modal" id="modal1">
    <div class="wrap">
            ...
            <!-- *** A -->
                <div class="qaSection qaSection-a">
                    ...
                    <div class="qaSection_content">
                        <p>平成27年度に建てられた首都圏のマンションの数は前年に比べて減少しているものの、地価の上昇や建設コストの影響などで平均価格が4年連続アップ※。このことは都心部のマンションを購買したい層が増加傾向にあり、業界全体として景気が下がりにくい状況を示しています。また当社の主要事業である資産運用型の不動産も、認知拡大や住宅ローンの低金利などにより購入者が増えているため、今後も好調が続く分野と考えられます。</p>
                        <p><small>※(株)不動産経済研究所調べ</small></p>
                    </div>
